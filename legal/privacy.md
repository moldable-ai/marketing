...
**We do not have access to this locally stored data.** It never leaves your machine unless you explicitly choose to share it (for example, by pushing to GitHub).
...
- The content of apps you create
- Your code or generated code
- Your local files or databases
- Your conversation history with the AI assistant
- API keys or credentials you configure locally

### 3.4 Third-party AI services

When you use AI features in Moldable, your prompts and queries are sent to third-party AI providers. These interactions are governed by the third-party provider's privacy policy. We recommend reviewing their policies:
...
**Be mindful of what you share with AI providers.** Avoid including sensitive information (passwords, API keys, personal data) in prompts unless you understand how the provider handles that data.
...
- **MCPs**: Model Context Protocol servers you connect
...
- View, modify, or delete any data in `~/.moldable/`
